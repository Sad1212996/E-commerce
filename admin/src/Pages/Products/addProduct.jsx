...
const AddProduct = () => {
    ...
    const setPreviewsFun = (previewsArr) => {
        if (!previewsArr || !Array.isArray(previewsArr)) return;
        const validImgs = previewsArr.filter(img => img && typeof img === 'string');
        setPreviews((prev) => {
            const updated = [...prev, ...validImgs];
            setFormFields((prevForm) => ({ ...prevForm, images: updated }));
            return updated;
        });
    }
    ...
    const setBannerImagesFun = (previewsArr) => {
        ...
        setBannerPreviews((prev) => {
            const updated = [...prev, ...validImgs];
            setFormFields((prevForm) => ({ ...prevForm, bannerimages: updated }));
            return updated;
        });
    }
        ...
        <section className='p-5 bg-gray-50'>
            <form className='form py-1 p-1 md:p-8 md:py-1' onSubmit={handleSubmitg}>
                <div className='scroll max-h-[72vh] overflow-y-scroll pr-4'>
                    ...
                    <div className='grid grid-cols-1 mb-3'>
                        <div className='col'>
                            <h3 className='text-[14px] font-[500] mb-1 text-black'>Product Description (Full)</h3>
                    ...
                    <div className='grid grid-cols-1 mb-3'>
                        <div className='col'>
                            <h3 className='text-[14px] font-[500] mb-1 text-black'>Product Small Description (For Card View)</h3>
                            <textarea type="text" placeholder="Enter short description for product card view..." className='w-full h-[80px] border border-[rgba(0,0,0,0.2)] focus:outline-none focus:border-[rgba(0,0,0,0.4)] rounded-sm p-3 text-sm' name="smallDescription" value={formFields.smallDescription} onChange={onChangeInput} />
                        </div>
                    </div>
