...
import { FaCheckDouble, FaCrown, FaUser } from "react-icons/fa6";
                                    ...
                                    userData?.users?.map((user, index) => {
                                        return (
                                            <TableRow key={index} className={user.checked === true ? '!bg-[#1976d21f]' : ''}>
                                                ...
                                                <TableCell style={{ minWidth: columns.minWidth }}>
                                                    {user?.role === "ADMIN" ? (
                                                        <span className="inline-flex items-center gap-1.5 py-1 px-3 rounded-full text-[11px] font-bold bg-purple-600 text-white shadow-sm">
                                                            <FaCrown className="text-[12px]" /> ADMIN
                                                        </span>
                                                    ) : (
                                                        <span className="inline-flex items-center gap-1.5 py-1 px-3 rounded-full text-[11px] font-semibold bg-slate-100 text-slate-700 border border-slate-300">
                                                            <FaUser className="text-[11px] opacity-70" /> CUSTOMER
                                                        </span>
                                                    )}
                                                </TableCell>
