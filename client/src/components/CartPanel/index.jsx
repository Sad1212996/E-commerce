              ...
              <div className="cartItem w-full flex items-center gap-4 border-b border-[rgba(0,0,0,0.1)] pb-4">
                ...
                <div className="info w-[75%] pr-5 relative pt-3">
                  ...
                  <p className="flex items-center gap-5 mt-2 mb-2">
                    ...
                    <span className="text-[#059669] font-bold">฿{(parseFloat(item?.price) || 0).toLocaleString()}</span>
                  </p>
            ...
            <span className="text-[#059669] font-bold">
              ฿{
                (context.cartData?.length > 0 ?
                  context.cartData?.map(item => (parseFloat(item.price) || 0) * (parseInt(item.quantity) || 1))
