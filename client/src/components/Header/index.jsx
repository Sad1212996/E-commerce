...
import { MdOutlineShoppingCart, MdOutlineWbSunny, MdOutlineNightsStay, MdLanguage } from "react-icons/md";
        ...
        <div className="header py-2 lg:py-4 border-b-[1px] border-gray-250">
          <div className="container flex items-center justify-between">
            ...
            <div className="col1 w-[40%] lg:w-[25%]">
              <Link to={"/"}>
                <img src={localStorage.getItem('logo') || '/logo.jpg'} className="max-w-[140px] lg:max-w-[200px] object-contain" alt="Flora Blossom Logo" />
              </Link>
            </div>
                  ...
                  <>
                    {
                      ...
                      <li>
                        <Button
                          ...
                          onClick={handleClick}
                        >
                          <div className="w-[40px] h-[40px] min-w-[40px] rounded-full bg-gray-200 overflow-hidden flex items-center justify-center p-0">
                            {
                              context?.userData?.avatar ? (
                                <img src={context?.userData?.avatar} className="w-full h-full object-cover" alt="User Avatar" />
                              ) : (
