                        ...
                        return (
                          <>
                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                              ...
                              <td className="px-6 py-4 font-[500] text-red-600 font-bold">฿{(parseFloat(order?.totalAmt) || 0).toLocaleString()}</td>
                                      ...
                                      <tbody>
                                        {
                                          order?.products?.map((item, index) => {
                                            return (
                                              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <td className="px-6 py-4 font-[500]">฿{(parseFloat(item?.price) || 0).toLocaleString()}</td>

                                                <td className="px-6 py-4 font-[500]">฿{((parseFloat(item?.price) || 0) * (parseInt(item?.quantity) || 1)).toLocaleString()}</td>
                                              </tr>
                                            )
                                          })
                                        }
                                         ...
                                         <tr className="bg-gray-100 font-bold">
                                           <td colSpan="5" className="px-6 py-3 text-right">Total Amount:</td>
                                           <td className="px-6 py-3 text-red-600">฿{(parseFloat(order?.totalAmt) || 0).toLocaleString()}</td>
                                         </tr>
                                      </tbody>
                                    </table>
                                  </div>
