...
const CartItems = (props) => {
  ...
  const [selectedSize, setCartItems] = useState(typeof props.selected === 'function' ? props.selected() : props.selected || "");
  ...
  return (
    <div className="cartItem w-full p-3 flex items-center gap-4 pb-5 border-b border-[rgba(0,0,0,0.1)]">
     ...
     font-[600] py-1 px-2 rounded-md cursor-pointer"
        ...
        <div className="flex items-center gap-4 mt-2">
          <span className="price text-[14px]  font-[600]">฿{(parseFloat(props?.item?.price) || 0).toLocaleString()}</span>
