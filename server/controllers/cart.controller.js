...
export const addToCartItemController = async (request, response) => {
    try {
        ...
        if (checkItemCart) {
            const newQty = checkItemCart.quantity + addQty;
            const newSubTotal = checkItemCart.price * newQty;

            checkItemCart.quantity = newQty;
            checkItemCart.subTotal = newSubTotal;
            if (size) checkItemCart.size = size;
            if (weight) checkItemCart.weight = weight;
            if (ram) checkItemCart.ram = ram;
        ...
        const cartItem = new CartProductModel({
            ...
            oldPrice: oldPrice,
            quantity: addQty,
            subTotal: subTotal || (price * addQty),
            productId: productId,
