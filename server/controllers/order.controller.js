...
export const createOrderController = async (request, response) => {
    try {
        ...
        let order = new OrderModel({
            ...
            paymentMethod: request.body.paymentMethod || "COD",
            paymentSlip: request.body.paymentSlip || "",
        ...
        for (let i = 0; i < request.body.products.length; i++) {
            ...
            const currentSale = (typeof product?.sale === 'number' && !isNaN(product?.sale)) ? product.sale : 0;
            const qty = parseInt(request.body.products[i].quantity) || 1;
            const currentStock = parseInt(request.body.products[i].countInStock || product?.countInStock || 0) || 0;

            await ProductModel.findByIdAndUpdate(
                request.body.products[i].productId,
                {
                    countInStock: Math.max(0, currentStock - qty),
                    sale: currentSale + qty
                },
                { new: true }
            );
        }
        ...
        for (let i = 0; i < ordersList.length; i++) {
            ...
            if (currentYear == year) {
                ...
                if (month === 1) {
                    monthlySales[0] = {
                        name: 'JAN',
                        TotalSales: parseInt(monthlySales[0].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 2) {
                    monthlySales[1] = {
                        name: 'FEB',
                        TotalSales: parseInt(monthlySales[1].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 3) {
                    monthlySales[2] = {
                        name: 'MAR',
                        TotalSales: parseInt(monthlySales[2].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 4) {
                    monthlySales[3] = {
                        name: 'APRIL',
                        TotalSales: parseInt(monthlySales[3].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 5) {
                    monthlySales[4] = {
                        name: 'MAY',
                        TotalSales: parseInt(monthlySales[4].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 6) {
                    monthlySales[5] = {
                        name: 'JUNE',
                        TotalSales: parseInt(monthlySales[5].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 7) {
                    monthlySales[6] = {
                        name: 'JULY',
                        TotalSales: parseInt(monthlySales[6].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 8) {
                    monthlySales[7] = {
                        name: 'AUG',
                        TotalSales: parseInt(monthlySales[7].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 9) {
                    monthlySales[8] = {
                        name: 'SEP',
                        TotalSales: parseInt(monthlySales[8].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 10) {
                    monthlySales[9] = {
                        name: 'OCT',
                        TotalSales: parseInt(monthlySales[9].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 11) {
                    monthlySales[10] = {
                        name: 'NOV',
                        TotalSales: parseInt(monthlySales[10].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
                ...
                if (month === 12) {
                    monthlySales[11] = {
                        name: 'DEC',
                        TotalSales: parseInt(monthlySales[11].TotalSales || 0) + parseInt(ordersList[i].totalAmt || ordersList[i].totalAmount || 0)
                    }
                }
